class AppStrings {
  ...
  static const String begin = 'Begin using the app by logging in.';
  static const String byContinuing = 'By continuing you agree to our';
  static const String terms = 'Terms & Services';
  static const String phoneVerification = 'Phone Verification';
  static const String enterSixDigits =
      'Enter the 6-digit code sent to your phone number';
  static const String resend = 'Resend Code';

  static const String overview = 'Overview';
  static const String overviewDescription =
      '''SOS sends push notification to all your\nemergency contacts with geolocation included\nor not in a custom message. Additionally shares\nyour geolocation.''';
