...
import 'package:sicherr/presentation/widgets/app_country_code_picker/selection_dialog.dart';

import 'country_code.dart';
import 'country_codes.dart';

class AppCountryCodePicker extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return AppCountryCodePickerState(elements);
  }
}

class AppCountryCodePickerState extends State<AppCountryCodePicker> {
  CountryCode? selectedItem;
  List<CountryCode> elements = [];
  List<CountryCode> favoriteElements = [];

  AppCountryCodePickerState(this.elements);
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.builder != null) {
      ...
      internalWidget = UnconstrainedBox(
        child: TextButton(
          style: ButtonStyle(
                  ...
                  Flexible(
                    ...
                    child: Padding(
                        padding: widget.alignLeft
                            ? const EdgeInsets.only(right: 7.0, left: 8.0)
                            : const EdgeInsets.only(right: 7.0),
                        child: Icon(
  ...
  @override
  void didUpdateWidget(AppCountryCodePicker oldWidget) {
